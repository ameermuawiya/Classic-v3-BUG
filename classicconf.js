...
global.gr = 'https://chat.whatsapp.com/KWWS6H2nSRQ4oEBmMAtWLK'
global.ig = 'ameermuawiyasangha
global.email = 'ameermuavia604@gmail.com
global.region = 'Pakistan
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'ꪶ༺֎ᚏ༈࿉𝐀𝐌𝐄𝐄𝐑-𝐌𝐔𝐀𝐖𝐈𝐘𝐀⧉ᚙ֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['923472207399'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
...
global.author = '༻࿇𝐀𝐌𝐄𝐄𝐑-𝐌𝐔𝐀𝐖𝐈𝐘𝐀❖༺' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
